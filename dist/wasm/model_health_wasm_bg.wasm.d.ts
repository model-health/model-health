...
export const modelhealthservice_activitiesForSubject: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
...
export const __wasm_bindgen_func_elem_1630: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_1213: (a: number, b: number, c: number) => void;
