...
```swift
dependencies: [
    .package(url: "https://github.com/model-health/model-health-swift.git", from: "0.9.0")
]
```
...
```bash
npm install @modelhealth/modelhealth@0.9.0
```

### npm (3D View)

```bash
npm install @modelhealth/viewer-react@0.9.0
```

### pip

```bash
pip install modelhealth==0.9.0
```
