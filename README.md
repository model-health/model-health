...
```swift
dependencies: [
    .package(url: "https://github.com/model-health/model-health.git", from: "0.1.0")
]
```
...
```bash
npm install @modelhealth/sdk@0.1.0
```
...
**Version 0.1.0** - View [all releases](https://github.com/model-health/model-health/releases) for version history.
