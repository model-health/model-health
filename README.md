...
```swift
dependencies: [
    .package(url: "https://github.com/model-health/model-health.git", from: "0.1.5")
]
```
...
```bash
npm install @modelhealth/sdk@0.1.5
```
...
**Version 0.1.5** - View [all releases](https://github.com/model-health/model-health/releases) for version history.
