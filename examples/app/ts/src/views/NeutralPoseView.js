...
export function render(container, state, { setState, navigate }) {
  ...
  container.innerHTML = `
    <div class="view-header">
      ...
      <p class="view-subtitle">Use a neutral standing pose to scale a 3D biomechanical model to the size of the subject. <a href="https://sdk.modelhealth.io/docs/guides/subject-calibration" target="_blank">Learn more</a></p>
    </div>
